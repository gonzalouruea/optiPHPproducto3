    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('reservas.index') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                    Ver Reservas
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('reservas.create') }}" class="inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                    Crear Reserva
                </a>
            </div>
        </div>
