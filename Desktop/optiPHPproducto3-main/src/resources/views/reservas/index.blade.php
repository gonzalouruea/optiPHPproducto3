...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    @else
        <a href="{{ route('usuario.reservas.create') }}" class="btn btn-primary">
            <i class="fas fa-plus"></i> Nueva Reserva
        </a>
    @endif
</div>
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Hotel:</strong> {{ $reserva->hotel->descripcion ?? 'N/A' }}</p>
                    ...
                    <div class="card-footer">
                        <small class="text-muted">Reservado: {{ \Carbon\Carbon::parse($reserva->fecha_reserva)->format('d/m/Y H:i') }}</small>
                        <div class="mt-2">
