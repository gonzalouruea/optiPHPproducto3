    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav me-auto">
          @auth
          <li class="nav-item"><a class="nav-link" href="{{ Auth::user()->rol === 'corporativo' ? route('hotel.dashboard') : (Auth::user()->rol === 'admin' ? route('admin.panel') : route('usuario.dashboard')) }}">Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="{{ route('usuario.reservas.index') }}">Mis Reservas</a></li>
          <li class="nav-item"><a class="nav-link" href="{{ route('usuario.reservas.create') }}">Nueva Reserva</a></li>
          <li class="nav-item"><a class="nav-link" href="{{ Auth::user()->rol === 'admin' ? route('admin.editar-perfil') : route('usuario.editar-perfil') }}">Editar Perfil</a></li>
      ...
      @else
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li><a class="dropdown-item" href="{{ Auth::user()->rol === 'admin' ? route('admin.editar-perfil') : route('usuario.editar-perfil') }}">Mi Perfil</a></li>
          <li>
          <hr class="dropdown-divider">
          </li>
          <li>
