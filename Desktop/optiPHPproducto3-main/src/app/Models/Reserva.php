...
class Reserva extends Model
{
  ...
  /**
   * Obtiene la zona asociada a la reserva a través del hotel.
   */
  public function zona()
  {
    return $this->hasOneThrough(
        Zona::class,
        Hotel::class,
        'id_hotel', // clave foránea en hotel
        'id_zona',  // clave local en zona
        'id_hotel', // clave local en reserva
        'id_zona'   // clave foránea en zona
    );
  }
  ...
  /**
   * Obtiene el precio asociado a la reserva.
   */
  public function precio()
  {
    return $this->belongsTo(Precio::class, ['id_zona', 'id_vehiculo'], ['id_zona', 'id_vehiculo']);
  }
}
